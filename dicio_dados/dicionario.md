...
<head>
    ...
    <title>X Personal Studio | Dicionário de Dados</title>
...
<aside class="sidebar">
    ...
    <div class="logo">
        ...
        <div class="logo-text">
            X PERSONAL<br><span>STUDIO</span>
        </div>
...
<main class="main">
    ...
    <header class="hero">
        ...
        <div class="hero-content">
            ...
            <p>
                Sistema de Gestão de Academia — X Personal Studio.
...
(DS_OBSERVACOES_MEDICAS)
    ...
    <footer>
        ...
        <strong>X PERSONAL STUDIO</strong>
